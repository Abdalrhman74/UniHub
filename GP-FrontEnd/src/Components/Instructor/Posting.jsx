  ...
  return (
      ...
      <>
        ...
        <div className="mt-4">
          ...
          <input
            ...
            className="mt-1 block size-4	pl-1 border border-gray-300  shadow-sm w-1/2 "
            required
          />
    ...
    <div className="mt-4">
      ...
      <textarea
        ...
        className="mt-1 block w-1/2 border border-gray-300 rounded-md shadow-sm pl-1"
        required
      />
    ...
    >   
                ...
                <div className='text-black'>No posts available.</div>
              )}
            </main>
          </div>
        </div>
