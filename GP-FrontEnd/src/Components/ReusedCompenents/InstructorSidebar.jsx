...
const InstructorSidebar = () => {
  ...
  function logOut() {
    ...
    useEffect(() => {
        ...
        if (path === '/InstructorHome') {
            setActiveLink('InstructorHome');
        }  else if (path === '/InstructorSettings') {
            setActiveLink('InstructorSettings');
        } 
        else if (path === '/InstructorAddTask') {
            setActiveLink('InstructorAddTask');
        }
                ...
                <div class="flex flex-col w-full font-medium">
                    ...
                    <div>
                        <span class="select-none flex items-center px-4 py-3 cursor-pointer my-[.4rem] rounded-xl">
                            <Link to={'/InstructorHome'}className={`flex items-center flex-grow text-[1.15rem] dark:text-neutral-400/75 hover:text-white ${activeLink === 'InstructorHome' ? 'text-white' : 'text-muted'}`} onClick={() => handleSetActiveLink('InstructorHome')}>My Courses</Link>
                        </span>
                    </div>
                    ...
                    <div>
                        <span class="select-none flex items-center px-4 py-3 cursor-pointer my-[.4rem] rounded-xl">
                            <Link to={'/InstructorAddTask'} 
                           className={`flex items-center flex-grow text-[1.15rem] dark:text-neutral-400/75 hover:text-white ${activeLink === 'InstructorAddTask' ? 'text-white' : 'text-muted'}`} 
                           onClick={() => handleSetActiveLink('InstructorAddTask')}>
                                ToDo List
                                </Link>
                        </span>
                    </div>
