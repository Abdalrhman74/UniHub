...
--
-- Dumping data for table `usermaterials`
--

LOCK TABLES `usermaterials` WRITE;
/*!40000 ALTER TABLE `usermaterials` DISABLE KEYS */;
/*!40000 ALTER TABLE `usermaterials` ENABLE KEYS */;
UNLOCK TABLES;
