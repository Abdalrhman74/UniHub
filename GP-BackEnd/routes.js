...
const { signUp, signIn, editUser, viewProfile, forgetPassword, checkOTP,
...
const { createCourse, deleteCourse, editCourse, listAllUsers ,deleteUser} = require('./Controllers/adminController');
